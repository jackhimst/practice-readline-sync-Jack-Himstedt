...
let questionThree = readline.question("What is an example of a falsy value in Boolean type conversion? ");
...
console.log('Question 3 Answer: Examples of falsy values include 0, null, undefined, NaN, "" or empty string, and false.');
